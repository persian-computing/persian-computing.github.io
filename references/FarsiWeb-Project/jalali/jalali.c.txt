...
char *j_month_name[13] = {"", "Farvardin", "Ordibehesht", "Khordad", "Tir",
...
/*
	br_time = (struct tm*) malloc(sizeof br_time);
	br_time->tm_year = 2001-1900;
	br_time->tm_mon = 3-1;
	br_time->tm_mday = 31;
*/
	gregorian_to_jalali(&y, &m, &d,
	                    ...
	                    br_time->tm_mday);
/*
	gregorian_to_jalali(&y, &m, &d, 1992, 3, 20);
*/
